...
import '../../util/social_media_icons_icons.dart';
...
import '../entity/spotify/spotify_album_view.dart';
import '../entity/spotify/spotify_artist_view.dart';
import '../entity/spotify/spotify_dialog.dart';
import '../entity/spotify/spotify_playlist_view.dart';
...
class LastFmSearchView extends StatefulWidget {
  const LastFmSearchView({super.key});

  @override
  State<StatefulWidget> createState() => _LastFmSearchView();
}

class _LastFmSearchView extends State<LastFmSearchView>
  ...
  void initState() {
    ...
    _tabController = TabController(
        length: _searchEngine == SearchEngine.lastfm ? 2 : 3, vsync: this);
  ...
  void _updateTabController([SearchEngine? searchEngine]) {
    ...
    var length = (searchEngine ?? _searchEngine) == SearchEngine.lastfm ? 2 : 3;
    setState(() {
      _tabController = TabController(
