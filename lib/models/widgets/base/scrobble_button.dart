...
import 'package:gem/models/widgets/base/scrobble.dart';
import 'package:in_app_review/in_app_review.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';

import '../../services/generic.dart';
import '../../util/constants.dart';
import 'batch_scrobble_view.dart';
...
class ScrobbleButton<T extends Entity> extends StatefulWidget {
  ...
  const ScrobbleButton({super.key, this.entity, this.entityProvider, this.color})
